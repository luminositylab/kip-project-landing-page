...
const Footer = (props) => (
    <footer style={{color: "#2454A3"}} id="footer">
        ...
        <section>
            ...
            <ul className="icons">            
                <li><a 
                href="https://www.instagram.com/kiprobot/" 
                className="icon fa-instagram alt" 
                style={{backgroundColor: "#8CC9F0"}}><span className="label">Instagram</span></a></li>
                <li><a href="https://github.com/orgs/luminositylab/teams/project-kip"
                className="icon fa-github alt"
                style={{backgroundColor: "#8CC9F0"}}><span className="label">Github</span></a></li>
            </ul>
        </section>
